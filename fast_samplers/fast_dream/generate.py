...
class DreamGenerationMixin:
    ...
    def _prepare_special_tokens(
        ...
        # Keep processed tensors separate from serializable token attributes for compilation support.
    ...
    def _sample(
        ...
        for num_block in range(num_blocks):
            ...
            while True:
                ...
                # attention_mask is [B, 1, N, N] — slice query dim (dim 2) to match input length
                ...
                if alg == 'confidence_threshold':
                    ...
                    # Apply confidence thresholding independently to each batch row.
                    transfer_index = (full_confidence >= threshold)
                    # Always transfer at least one masked token per row.
